...
<li><a href="<c:url value='/search/internal.do' />?query=q&p=2">/search/internal.do</a>
			...
			<li><a href="<c:url value='/header/check.do' />">/header/check.do</a> (HeaderController, @RequestHeader 예제)</li>
			<li><a href="<c:url value='/search/main.do' />">/search/main.do</a>(GameSearchController, @ModelAttribute 예제)</li>
			<li><a href="<c:url value='/account/create.do' />">/account/create.do</a> (CreateAccountController, @ModelAttribute 및 폼 값 검증 예제)</li>
			...
			<li><a href="<c:url value='/login/login.do' />">/login/login.do</a>(LoginController, @InitBinder 및 @Valid를 이용한 폼 값 검증)</li>
			<li><a href="<c:url value='/report/submission.do' />">/report/submission.do</a>(ReportSubmissionController, 파일 업로드 예제)</li>
